...
const Middle = () => {
  return (
    ...
    <div style={{backgroundImage:`url(${middlesc})`}} className='bg-cover bg-center h-screen'><img src={maining} alt=""  className='w-80 absolute top-210 left-45'/> <img src={nodes} alt=""  className='w-80 absolute top-240 right-60'/></div>
    </div>
